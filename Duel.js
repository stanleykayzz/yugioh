...
var Duel = /** @class */ (function () {
    ...
    Duel.prototype.directAttack = function (attackingPlayer, targetPlayer, positionMonsterOnField, positionTargetAttack) {
        // TODO implement here
        ...
        if (positionMonsterOnField == 0)
            targetPlayer.lifePoints = targetPlayer.lifePoints - this.GameField.field1.monsterZone1.monsterPosition[0].attackPoints;
        else if (positionMonsterOnField == 1)
            targetPlayer.lifePoints = targetPlayer.lifePoints - this.GameField.field1.monsterZone1.monsterPosition[1].attackPoints;
        else if (positionMonsterOnField == 2)
            targetPlayer.lifePoints = targetPlayer.lifePoints - this.GameField.field1.monsterZone1.monsterPosition[2].attackPoints;
        else if (positionMonsterOnField == 3)
            targetPlayer.lifePoints = targetPlayer.lifePoints - this.GameField.field1.monsterZone1.monsterPosition[3].attackPoints;
        else if (positionMonsterOnField == 4)
            targetPlayer.lifePoints = targetPlayer.lifePoints - this.GameField.field1.monsterZone1.monsterPosition[4].attackPoints;
        //on verifie si il y a un gagnant et un perdant
        this.checkForWinner();
    };
    Duel.prototype.surrender = function (losingPlayer) {
    ...
    Duel.prototype.checkForWinner = function () {
    ...
    Duel.prototype.duelManager = function (listOfPlayers) {
    ...
    Duel.prototype.summonMonster = function (player, playerSide, handCardPosition) {
