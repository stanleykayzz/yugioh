...
var Rituel = /** @class */ (function (_super) {
    __extends(Rituel, _super);
    function Rituel(nom, des, star, scales, attribut, type, atk, def, effect) {
        var _this = 
        ...
        _this.ritFrame = FrameCard.blue;
        _this.rol = rankLevel.level;
        return _this;
    }
    Rituel.prototype.ToString = function () {
        console.log("carte rituel " + this.name + "avec " + this.rankOrLevel + " de " + this.stars + " étoiles avec une couleur " + this.ritFrame);
    };
    return Rituel;
}(Monster));
//# sourceMappingURL=Rituel.js.map